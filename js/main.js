(() => {
  ...
  const houseInfo = [
    ...
    ['Targaryen', 'House Targaryen of Dragonstone is an exiled Great House of Westeros and the former royal house of the Seven Kingdoms. House Targaryen conquered and unified the realm before it was deposed during Roberts Rebellion and House Baratheon replaced it as the new royal House. The two surviving Targaryens, Viserys and Daenerys, fled into exile to the Free Cities of Essos across the Narrow Sea.'],

    ['Trell', 'House Tyrell of Highgarden is an extinct Great House of Westeros. It ruled over the Reach, a vast, fertile, and heavily-populated region of southwestern Westeros, from their castle-seat of Highgarden as Lords Paramount of the Reach and Wardens of the South after taking control of the region from House Gardener during the Targaryen conquest.']
  ];
  ...
  {
    vid.volume=document.getElementById("change_vol").value;
  }
  ...
  function popLightBox(event) {
    if (event.target.className.includes('sigilContainer')) {
      ...
      setTimeout(function(){setVideoSource(targetHouse)}, 1500);
